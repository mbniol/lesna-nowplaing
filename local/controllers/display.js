...
class Controller {
  ...
  static showAmountOfClients() {
    setInterval(() => console.log(Controller.#clients.length), 2000);
  }

  static async sendDataToClientsFromPlayer(req, res) {
    console.log("wysylanie zplayera ", new Date());
    sendEventsToAll(Controller.#clients, req.body);
    res.sendStatus(200);
  }
  static async sendDataToClients(data) {
    console.log("wysylanie z serwerra: ", new Date());
