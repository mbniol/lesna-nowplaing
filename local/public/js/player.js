  ...
  setTimeout(() => {
    ...
    player.addListener(
      ...
      async ({
        ...
        const pauseStateChange = lastRequest.paused !== paused;
        ...
        if (
          ...
          (!trackStateChange &&
            position === 0 &&
            !paused &&
            currTime - lastRequest.time > 1000)
        ) {
          const lastRequestCopy = lastRequest;
          lastRequest = {
          ...
          console.log("afterloop", fetch_queue);
          lastRequest.queue = fetch_queue;
          // if (
          //   lastRequestCopy.id === event_current_track.id &&
          //   // lastRequestCopy.position === position &&
          //   lastRequestCopy.paused !== paused
          // ) {
          ...
          //   lastRequestCopy.id === event_current_track.id &&
          //   lastRequestCopy.position !== position &&
          //   sameQueue(lastRequestCopy.queue, fetch_queue)
          // ) {
